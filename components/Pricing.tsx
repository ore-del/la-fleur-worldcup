    ...
    <section id="pricing" ref={ref as React.RefObject<HTMLElement>} className="relative bg-[#080603] py-20 px-16 overflow-hidden">
      ...
      <div className="reveal grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-[1184px] mx-auto">
        ...
        <div className="card-spring bg-white/[0.03] border-[1.5px] border-[rgba(59,112,70,0.25)] rounded-[16px] overflow-hidden p-[30.5px] relative min-h-[540px] hover:border-[rgba(59,112,70,0.45)]">
          ...
          <div className="h-px bg-[rgba(59,112,70,0.12)] my-4" />
        ...
        {/* Premium */}
        <div className="card-spring bg-white/[0.05] border-2 border-[rgba(59,112,70,0.5)] rounded-[16px] overflow-hidden relative min-h-[540px] hover:border-[rgba(59,112,70,0.8)]">
          <div className="bg-[#3b7046] h-[40px] flex items-center justify-center">
          ...
          <div className="px-[30px] pb-[90px] pt-4">
            ...
            <div className="inline-flex items-baseline gap-2 bg-[rgba(59,112,70,0.15)] border border-[rgba(59,112,70,0.4)] rounded-[8px] px-[7px] py-1 mb-2">
              <span className="text-[#6db87e] font-bold text-[48px] tracking-[-2px]">$249</span>
              <span className="text-white/30 text-[18px] line-through">$499</span>
            </div>
            <p className="text-white/40 text-[13px] mb-3">{p.premiumBilling}</p>
            <div className="h-px bg-[rgba(59,112,70,0.18)] mb-4" />
          ...
          <a href="#claim" className="btn-spring absolute bottom-[30px] left-[30px] right-[30px] h-[52px] leading-[52px] text-center bg-[#3b7046] text-white font-semibold text-[15px] rounded-[8px] hover:bg-[#6db87e] block">
            {p.premiumCta}
          </a>
        </div>
      </div>
