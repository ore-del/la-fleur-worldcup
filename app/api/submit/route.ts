...
export async function POST(req: Request) {
  ...
  await send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px;background:#0d0c0a;color:#fff;border-radius:12px">
        <h2 style="color:#6db87e;margin:0 0 24px">New Spot Claimed</h2>
        <table style="width:100%;border-collapse:collapse">
          ...
          <tr><td style="padding:10px 0;color:#999">Package</td><td style="padding:10px 0;color:#6db87e;font-weight:600">${pkg}</td></tr>
        </table>
  ...
  await send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px;background:#0d0c0a;color:#fff;border-radius:12px">
        <h2 style="color:#6db87e;margin:0 0 8px">Spot Claimed.</h2>
        <p style="color:#999;margin:0 0 24px;font-size:16px">Hi ${bizName}, you're on the list.</p>
        <p style="line-height:1.7;color:#ccc">You've reserved your <strong style="color:#6db87e">${pkg}</strong> spot. We'll reach out within 24 hours to get things moving before the World Cup kicks off.</p>
        <p style="line-height:1.7;color:#ccc">If you have any questions in the meantime, reply to this email or reach us at <a href="mailto:${CONTACT_EMAIL}" style="color:#6db87e">${CONTACT_EMAIL}</a>.</p>
