    ...
    <section id="how-it-works" ref={ref as React.RefObject<HTMLElement>} className="relative bg-[#0a0804] py-20 px-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {h.steps.map((step, i) => (
          <div
            key={step.num}
            className={`reveal reveal-delay-${i + 1} card-spring relative bg-white/[0.03] border border-[rgba(59,112,70,0.2)] rounded-[16px] overflow-hidden p-5 h-[340px] hover:border-[rgba(59,112,70,0.4)] hover:bg-white/[0.05]`}
          >
