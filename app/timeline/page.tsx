      ...
      <div className="max-w-[960px] mx-auto px-6 pt-14 pb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-7">
            <div className="flex flex-col gap-2">
              <div className="w-8 h-8 rounded-full bg-[rgba(59,112,70,0.12)] border border-[rgba(59,112,70,0.3)] flex items-center justify-center mb-1">
                <span className="text-[#6db87e] font-bold text-[12px]">1</span>
              </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="w-8 h-8 rounded-full bg-[rgba(59,112,70,0.12)] border border-[rgba(59,112,70,0.3)] flex items-center justify-center mb-1">
                <span className="text-[#6db87e] font-bold text-[12px]">2</span>
              </div>
              ...
              <p className="text-white/45 text-[13px] leading-[1.55]">
                ...
                <a href={GOOGLE_FORM} target="_blank" rel="noopener noreferrer"
                  className="text-[#6db87e] hover:text-[#6db87e] underline transition-colors">
                  this form
                </a>
            ...
            <div className="flex flex-col gap-2">
              <div className="w-8 h-8 rounded-full bg-[rgba(59,112,70,0.12)] border border-[rgba(59,112,70,0.3)] flex items-center justify-center mb-1">
                <span className="text-[#6db87e] font-bold text-[12px]">3</span>
              </div>
                  ...
                  <div className="flex flex-col gap-[9px]">
                    {m.deliverables.map((d, j) => (
                      <div key={j} className="flex items-start gap-3">
                        <span className={`font-bold text-[12px] leading-[1.7] shrink-0 ${m.highlight ? 'text-[#6db87e]' : 'text-[#6db87e]'}`}>✓</span>
          ...
          <div className="flex flex-col gap-[10px]">
            {[
              ...
              <div key={i} className="flex items-start gap-3">
                <span className={`font-bold text-[12px] leading-[1.7] shrink-0 ${note.pos ? 'text-[#6db87e]' : 'text-white/30'}`}>{note.icon}</span>
        ...
        <div className="pt-10 text-center">
          <p className="text-white/20 text-[12px] leading-[1.8]">
            ...
            <a href="mailto:hello@la-fleur.ca" className="text-[#6db87e] hover:text-[#6db87e] transition-colors">
              hello@la-fleur.ca
            </a>
          </p>
