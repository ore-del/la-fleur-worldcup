...
function TestHero() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#c9900a]">
      ...
      />
      {/* Subtle dark overlay at top for header legibility */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-transparent to-transparent" />

      {/* Deadline bar — glass pill, flex-col layout matching Figma 106:6061 */}
      <div className="absolute left-1/2 -translate-x-1/2 top-[88px] z-10 pt-6 w-max">
        <div className="flex flex-col items-center gap-2 bg-white/10 backdrop-blur-md border border-white/[0.15] rounded-[65px] px-6 py-4">
          <p className="text-white text-[14px] font-bold leading-snug text-center">
            {h.deadlineBar}
          </p>
          <CountdownTimer />
        </div>
      ...
      {/* Main copy — driven by language context */}
