...
const heroBgImage  = 'https://raw.githubusercontent.com/ore-del/la-fleur-worldcup/claude/world-cup-generate-page-vuHuO/Feature%20image%20-%20Home.png'
...
function Hero({ onClaim }: { onClaim: () => void }) {
  const { tx } = useLanguage()
  const h = tx.hero
  const cta = tx.cta
